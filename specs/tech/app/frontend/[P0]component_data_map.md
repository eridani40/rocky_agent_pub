...
| studio | `useStudioUnreadMeta` studio 红点 | KeyedMap\<sid,bool\> | session_meta(_all) | 无(POST /read) | SSE | onInit: subscribe; onEvent: biz 守卫+applyKeyed set; markReadAndClear 命令式 | **修 G1 违规**：new SseClient→getSseClient() 单例 |
