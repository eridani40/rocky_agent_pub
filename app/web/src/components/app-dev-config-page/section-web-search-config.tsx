...
interface SectionWebSearchConfigProps {
  onDirtyChange?: (dirty: boolean) => void;
}

/** 网络搜索自渲染 section（forwardRef 暴露 save/reset 给 tab 级 aggregator） */
export const SectionWebSearchConfig = forwardRef<SectionSaveHandle, SectionWebSearchConfigProps>(function SectionWebSearchConfig({ onDirtyChange }, ref: ForwardedRef<SectionSaveHandle>) {
